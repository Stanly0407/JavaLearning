...
//побитовый оператор XOR: сравнивает соответствующие биты двух операндов и возвращает 1, если они равны,
// и 0, если они не равны. Например:
//num1 = 11; /* equal to 00001011*/
//num2 = 22; /* equal to 00010110 */

import java.util.Scanner;

public class SwapNumbXor {
